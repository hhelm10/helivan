...
const meta10 = {
  title:
    "A collection of language models is a digital twin of a social system //",
  arxiv: "",
...
const meta7 = {
  title:
    "Establishing the consistency of vector representations of black-box generative models //",
...
export function getHTML(index: any, slideIndex: any) {
  ...
  return (
    <div
      ...
      } overflow-auto section background-blue-1 text-blue-4 font-deja-vu`}
    >
    ...
    <div>
      <div className="static-header">
        <div>
          ...
          <a href="/">
            {" "}
            <img src={"/favicon.svg"} width="67rem" />{" "}
          </a>{" "}
        </div>
      ...
      <div
        className="text-xl text-blue-1 font-deja-vu"
        style={{ textAlign: "left", marginLeft: "12.5%", marginRight: "35%" }}
      >
        ...
        <p className="mt-2">
          {" "}
          At Helivan we believe that collections of generative models -- not
          just a single generative model -- will pervade everyone's social,
          domestic, and professional lives. These models will be embedded on a
          user's devices and have access to sensitive information. In some
          cases, these models will act as an extension of the user and will be
          able to sufficiently approximate their actions in a given context.
        </p>
        <p className="mt-6">
          As such, our research is focused on developing statistical methods and
          data analysis tools for comparing generative models in different
          accessibility regimes in the absence of an explicit task, for tracking
          the dynamics of models as they interact with each other and their
          environments, for understanding the relationship between
          machine-generated content and human-generated content, and for
          evaluating and addressing model robustness.
        </p>
        <p className="mt-6">
          Our research has allowed us to be the first to provide statistical
          evidence that a collection of appropriately defined language models is
          a "digital twin" for a social system.{" "}
        </p>
      </div>
      <div className="mt-8">
        <Slideshow />
      ...
      <div
        className="font-deja-vu text-4xl text-blue-1 text-center"
